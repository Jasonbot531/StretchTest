...
import frc.robot.commands.MoveElevatorCmd;
...
public class RobotContainer {
  ...
  //Reference to the ElevatorSubsytem class
  private final ElevatorSubsystem elevatorSubsystem = new ElevatorSubsystem();

  private final ExampleSubsystem m_exampleSubsystem = new ExampleSubsystem();

  private final Joystick joystickObject = new Joystick(InputConstants.kDriverControllerPort);

  // Replace with CommandPS4Controller or CommandJoystick if needed
  private final CommandXboxController m_driverController =
      new CommandXboxController(OperatorConstants.kJoystickPort);
